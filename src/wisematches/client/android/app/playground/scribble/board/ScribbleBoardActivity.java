...
import wisematches.client.android.app.playground.scribble.board.view.BoardView;
import wisematches.client.android.app.playground.scribble.board.view.BoardViewListener;
import wisematches.client.android.app.playground.scribble.board.view.ProgressView;
...
*/
/*
					final WiseMatchesServer.Response r = new WiseMatchesServer.Response(true, board);
					//getWiseMatchesClient().execute("/playground/scribble/board/load.ajax?browse=" + boardId);
					if (r.isSuccess()) {
